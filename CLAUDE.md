...
- [figma-kit.md](.claude/docs/figma-kit.md) — the "AVRG — Site Kit" Figma file: the site's parts as drag-around mockup assets. A translation layer, allowed to drift stale — **not** under the bench's change-with-charting law.
