...
ANCHORS = [
    ...
    ("renderLisst", r"function renderLisst", "YOUR PICKS page cards (one producer for both dresses: YOUR PICKS on the dock side, My Lisst on desktop)"),
    ("renderBay", r"function renderBay", "draws the drawer/bay shelf cards — the shelf's producer (flyToBay is only the flight)"),
    ...
    ("stayLand / dockDress", r"function stayLand", "the static text lands (no hover to earn a decode) — note: stayLand resolves dims||name, so THE LB CARD ALREADY RESTS ON DIMS on desktop"),
