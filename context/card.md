...
*Derived 2026-08-29 · commit eef2ff6 · index.html 17127 lines*
...
- `renderBay` (index.html:13092) — draws the drawer/bay shelf cards — the shelf's producer (flyToBay is only the flight)
- `the shop conveyor` (index.html:12374) — home belt cards (recycler owns their visibility)
- `flyToBay` (index.html:15714) — card -> drawer flight
- `setFlip / flipStage` (index.html:16284) — the flip system (chip = the hidden-face mini)
