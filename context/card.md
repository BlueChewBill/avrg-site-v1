...
*Derived 2026-08-30 · commit 780031d · index.html 17258 lines*
...
- `renderBay` (index.html:13218) — draws the drawer/bay shelf cards — the shelf's producer (flyToBay is only the flight)
- `the shop conveyor` (index.html:12500) — home belt cards (recycler owns their visibility)
- `flyToBay` (index.html:15841) — card -> drawer flight
- `setFlip / flipStage` (index.html:16415) — the flip system (chip = the hidden-face mini)
...
- `migrateHole` (index.html:11309) — lb exchange re-seats the grid hole on every landing
