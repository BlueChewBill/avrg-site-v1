...
*Derived 2026-08-29 · commit 0efc155 · index.html 17107 lines*
...
- `renderBay` (index.html:13072) — draws the drawer/bay shelf cards — the shelf's producer (flyToBay is only the flight)
- `the shop conveyor` (index.html:12354) — home belt cards (recycler owns their visibility)
- `flyToBay` (index.html:15694) — card -> drawer flight
- `setFlip / flipStage` (index.html:16264) — the flip system (chip = the hidden-face mini)
